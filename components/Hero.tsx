  ...
  return (
    <section id="home" className="relative h-[90vh] md:h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        ...
        {/* Camada de cor vibrante e clara para o tema tropical */}
        <div className="absolute inset-0 bg-gradient-to-b from-orange-500/40 via-transparent to-white/90"></div>
        <div className="absolute inset-0 bg-white/5 backdrop-brightness-110"></div>
      </div>

      <div className="relative z-10 text-center px-4 max-w-6xl">
        <div className="mb-6 md:mb-10 inline-block bg-white/30 backdrop-blur-md border border-white/50 px-6 py-2 rounded-full transform hover:scale-105 transition-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center items-center">
          <a
            ...
            className="bg-orange-600 text-white px-10 py-5 rounded-2xl font-black text-xl hover:bg-orange-500 transition-all transform hover:scale-105 shadow-2xl w-full sm:w-auto flex items-center justify-center gap-3"
          >
            Ver Passeios
            <span>→</span>
          </a>
          <a
            ...
            className="bg-yellow-400 text-slate-900 px-10 py-5 rounded-2xl font-black text-xl hover:bg-yellow-300 transition-all transform hover:scale-105 w-full sm:w-auto shadow-xl"
          >
            Sobre Nós
          </a>
        </div>
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 animate-bounce cursor-pointer z-20" onClick={(e) => scrollToSection(e as any, 'tours')}>
        <div className="w-8 h-12 rounded-full border-2 border-white/80 flex items-start justify-center p-2">
