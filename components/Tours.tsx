    ...
    <section id="tours" className="py-24 md:py-32 bg-slate-50 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 md:mb-24">
          ...
          <h2 className="text-4xl md:text-7xl font-serif font-black text-slate-900 mb-6">
            Nossos <span className="text-orange-500">Passeios</span>
          </h2>
          <div className="w-24 h-2 bg-yellow-400 mx-auto rounded-full"></div>
        </div>

        {/* Grid de Tours - Centralizado para 2 itens */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 max-w-5xl mx-auto justify-center">
          {TOURS.map((tour) => (
            <div 
              key={tour.id} 
              className="group bg-white rounded-[2rem] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.05)] transition-all duration-500 hover:-translate-y-3 hover:shadow-2xl border border-slate-100 flex flex-col"
            >
              {/* Imagem (Categoria removida daqui) */}
